<div id="cadastrar" class="col s12 m6 l6" style="border-left: 1px solid black">
  <div class="container">
    <div class="row">
      <h1 class="center Courgette">Alterar</h1>
      <!-- <h4 class="center">Cadastro</h4> -->
      <!-- INÍCIO FORM onsubmit="return validarSenha();"-->

      <form action="./control/altUser.php" method="POST" class="col s12" >
        ...
        <div class="row">
          ...
          <div class="col s12 m4 l4" style="margin-bottom: calc(100% + )">
            <button class="btn waves" style="width: 100%" type="submit">Alterar
